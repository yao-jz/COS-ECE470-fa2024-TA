...
2. Run `cargo build`, which generates `netid/COS-ECE470-fa2024-TA-main/target/debug/bitcoin`. It is the runnable binary of your code. (Windows may have `*.exe`, and it's okay.)
